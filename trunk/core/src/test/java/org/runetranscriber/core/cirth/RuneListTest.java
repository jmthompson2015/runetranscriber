...
public final class RuneListTest
{
    ...
    public void testToString()
    {
        ...
        assertThat(
                result,
                is("C11-C55-SPACE-C31-C50-C12-C9-SPACE-C50-C4-SPACE-C11-C55-SPACE-C12-C39-C36-C34-SPACE-C8-C12-C48-C53-C34-C31-C48-C8-C55-C9-SPACE-C3-C12-C50-C6-SPACE-C11-C55-SPACE-C12-C46-C9-SPACE-C2-C51-C18"));
    }
}
