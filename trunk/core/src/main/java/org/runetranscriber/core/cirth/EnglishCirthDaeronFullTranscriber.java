 ...
 */
public final class EnglishCirthDaeronFullTranscriber implements FullTranscriber<Certh, CerthFontLetter>
{
    /** Delegate. */
    ...
    public EnglishCirthDaeronFullTranscriber()
    {
        ...
        final RuneTranscriber<Certh> runeTranscriber = new CirthDaeronRuneTranscriber();
