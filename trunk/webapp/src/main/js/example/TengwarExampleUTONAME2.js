...
var TengwarExampleUTONAME2 =
{
    ...
    LANGUAGE_WORDS: [ "are", " ", "told", " ", "many", " ", "things", " ",
            "of", " ", "men", " ", "and", " ", "elves", " ", "in", " ",
            "numenor", " ", "and", " ", "in", " ", "middle", "\n", "earth",
            " ", "from", " ", "the", " ", "elder", " ", "days", " ", "in", " ",
            "beleriand", " ", "to", " ", "the", " ", "war", " ", "of the", " ",
            "ring", " ", "and", "\n", "an", " ", "account", " ", "is", " ",
            "given", " ", "of the", " ", "druedain", " ", "the", " ", "istari",
            " ", "and", " ", "the", " ", "palantiri", "." ],

    PHONEMES: [ [ "a", "r", "e" ], " ", "t", [ "o", "l" ], "d", " ", "m",
            [ "a", "n" ], "y", " ", "th", [ "i", "ng" ], "s", " ", "of", " ",
            "m", [ "e", "n" ], " ", "and", " ", [ "e", "l" ], [ "v", "e" ],
            "s", " ", [ "i", "n" ], " ", "n", [ "u", "m" ], [ "e", "n" ],
            [ "o", "r" ], " ", "and", " ", [ "i", "n" ], " ", "m",
            ...
            [ "e", "r" ], " ", "d", [ "a", "y" ], "s", " ", [ "i", "n" ], " ",
            "b", [ "e", "l" ], [ "e", "r" ], "i", [ "a", "n" ], "d", " ", "t",
            "o", " ", "the", " ", "w", [ "a", "r" ], " ", "of the", " ", "r",
            [ "i", "ng" ], " ", "and", "\n", [ "a", "n" ], " ",
            [ "a", "k", "k" ], [ "o", "u" ], "n", "t", " ", [ "i", "s" ], " ",
            "g", [ "i", "v" ], [ "e", "n" ], " ", "of the", " ", "d", "r",
            [ "u", "e" ], "d", "ai", [ "i", "n" ], " ", "the", " ",
            [ "i", "s" ], "t", [ "a", "r" ], "i", " ", "and", " ", "the", " ",
            "p", [ "a", "l" ], [ "a", "n" ], "t", [ "i", "r" ], "i", "." ],
