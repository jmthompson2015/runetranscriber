...
var TengwarExampleTROTS1 =
{
    ...
    LANGUAGE_WORDS: [ "in", " ", "the", " ", "return", " ", "of the", " ",
            "shadow", " ", "are", " ", "traced", " ", "the", " ", "first", " ",
            "forms", " ", "of the", " ", "story", " ", "of the", " ", "lord",
            "\n", "of the", " ", "rings", ".", "herein", " ", "the", " ",
            "journey", " ", "of the", " ", "hobbit", " ", "who", " ", "bore",
            " ", "the", " ", "great", " ", "ring", ",", "at", " ", "first" ],

    PHONEMES: [ [ "i", "n" ], " ", "the", " ", [ "r", "e" ], "t", [ "u", "r" ],
            "n", " ", "of the", " ", "sh", [ "a", "d" ], [ "o", "w" ], " ",
            [ "a", "r", "e" ], " ", "t", "r", [ "a", "c", "e" ], "d", " ",
            "the", " ", "f", [ "i", "r" ], "s", "t", " ", "f", [ "o", "r" ],
            "m", "s", " ", "of the", " ", "s", "t", [ "o", "r" ], "y", " ",
            "of the", " ", "l", [ "o", "r" ], "d", "\n", "of the", " ", "r",
            [ "i", "ng" ], "s", ".", "h", [ "e", "r", "e" ], [ "i", "n" ], " ",
            "the", " ", "j", [ "o", "u" ], "r", "n", [ "e", "y" ], " ",
            "of the", " ", "h", [ "o", "b", "b" ], [ "i", "t" ], " ", "wh",
            "o", " ", "b", [ "o", "r", "e" ], " ", "the", " ", "g", "r",
            [ "e", "a" ], "t", " ", "r", [ "i", "ng" ], ",", [ "a", "t" ], " ",
            "f", [ "i", "r" ], "s", "t" ],
    ...
    RUNES: [
            ...
            TengwaRune.SPACE,
            // return
            [ TengwaRune.ROMEN, TengwaRune.UNDER_DOT ],
            TengwaRune.TINCO,
            ...
            // herein
            TengwaRune.HYARMEN,
            [ TengwaRune.DOT, TengwaRune.ROMEN, TengwaRune.UNDER_DOT ],
            [ TengwaRune.ACUTE, TengwaRune.NUMEN ],
            TengwaRune.SPACE,
            // the
            TengwaRune.THE,
            ...
            // bore
            TengwaRune.UMBAR,
            [ TengwaRune.LEFT_CURL, TengwaRune.ROMEN, TengwaRune.UNDER_DOT ],
            TengwaRune.SPACE,
            // the
            TengwaRune.THE,
            TengwaRune.SPACE,
