 ...
 */
public final class EnglishCirthMoriaFullTranscriber implements FullTranscriber<CerthRune, CerthFontLetter>
{
    /** Delegate. */
     ...
     */
    public EnglishCirthMoriaFullTranscriber()
    {
        final String displayName = "English to Cirth (Moria) rune transcriber";
        final String description = "Transcribes English to Cirth (Moria) runes and back.";
        final PhoneticTranscriber phoneticTranscriber = new EnglishCirthPhoneticTranscriber();
        final RuneTranscriber<CerthRune> runeTranscriber = new CirthMoriaRuneTranscriber();
