...
/**
 * Provides tests for the <code>LanguageLetterListFactory</code> class.
 */
public final class LanguageLetterListFactoryTest
{
    /** Factory. */
    private final LanguageLetterListFactory factory = new LanguageLetterListFactory();
    ...
    public void create0()
    {
        final LanguageLetterList list = factory.create();
    ...
    public void create1()
    {
        ...
        final LanguageLetterList list = factory.create(inputList);
