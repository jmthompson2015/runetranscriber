define([ "AngloSaxonRune", "AurebeshRune", "CerthRune", "EnglishAngloSaxonTranscriber", "EnglishAurebeshTranscriber",
        ...
        "example/KryptonianExampleDC1", "example/TengwarExample1", "example/TengwarExampleSD1",
        "example/TengwarExampleSD2", "example/TengwarExampleTLOTR2", "example/TengwarExampleTROTS1",
        "example/TengwarExampleTROTS2", "example/TengwarExampleTS1", "example/TengwarExampleTS2",
        "example/TengwarExampleTTOI1", "example/TengwarExampleTTOI2", "example/TengwarExampleTWOTR1",
        "example/TengwarExampleTWOTR2", "example/TengwarExampleUTONAME1", "example/TengwarExampleUTONAME2" ], function(
        AngloSaxonRune, AurebeshRune, CerthRune, EnglishAngloSaxonTranscriber, EnglishAurebeshTranscriber,
        EnglishCirthEreborTranscriber, EnglishKryptonianTranscriber, EnglishTengwarTranscriber, KryptonianRune,
        TengwaRune, AngloSaxonExample1, AngloSaxonExample2, AngloSaxonExample3, AngloSaxonExample4, AngloSaxonExample5,
        AngloSaxonExample6, AngloSaxonExample7, AngloSaxonExample8, AurebeshExampleSW1TPM1, AurebeshExampleSW4ANH1,
        CirthEreborExample1, CirthEreborExample2, KryptonianExampleDC1, TengwarExample1, TengwarExampleSD1,
