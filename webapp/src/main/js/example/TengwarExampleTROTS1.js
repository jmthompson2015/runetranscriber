...
var TengwarExampleTROTS1 =
{
    ...
    LANGUAGE_WORDS: [ "in", " ", "the", " ", "return", " ", "of the", " ", "shadow", " ", "are", " ", "traced", " ",
            "the", " ", "first", " ", "forms", " ", "of the", " ", "story", " ", "of the", " ", "lord", "\n", "of the",
            " ", "rings", ".", "herein", " ", "the", " ", "journey", " ", "of the", " ", "hobbit", " ", "who", " ",
            "bore", " ", "the", " ", "great", " ", "ring", ",", "at", " ", "first" ],

    PHONEMES: [ [ "i", "n" ], " ", "the", " ", [ "r", "e" ], "t", [ "u", "r" ], "n", " ", "of the", " ", "sh",
            [ "a", "d" ], [ "o", "w" ], " ", [ "a", "r", "e" ], " ", "t", "r", [ "a", "c", "e" ], "d", " ", "the", " ",
            "f", [ "i", "r" ], "s", "t", " ", "f", [ "o", "r" ], "m", "s", " ", "of the", " ", "s", "t", [ "o", "r" ],
            "y", " ", "of the", " ", "l", [ "o", "r" ], "d", "\n", "of the", " ", "r", [ "i", "ng" ], "s", ".", "h",
            [ "e", "r", "e" ], [ "i", "n" ], " ", "the", " ", "j", [ "o", "u" ], "r", "n", [ "e", "y" ], " ", "of the",
            " ", "h", [ "o", "b", "b" ], [ "i", "t" ], " ", "wh", "o", " ", "b", [ "o", "r", "e" ], " ", "the", " ",
            "g", "r", [ "e", "a" ], "t", " ", "r", [ "i", "ng" ], ",", [ "a", "t" ], " ", "f", [ "i", "r" ], "s", "t" ],
    ...
    [ TengwaRune.ROMEN, TengwaRune.UNDER_DOT ], TengwaRune.TINCO, [ TengwaRune.RIGHT_CURL, TengwaRune.ORE ],
            ...
            // shadow
            TengwaRune.HARMA, [ TengwaRune.THREE_DOTS, TengwaRune.ANDO ], [ TengwaRune.LEFT_CURL, TengwaRune.VALA ],
            TengwaRune.SPACE,
            // are
            ...
            TengwaRune.SPACE,
            // form
            TengwaRune.FORMEN, [ TengwaRune.LEFT_CURL, TengwaRune.ORE ], TengwaRune.MALTA, TengwaRune.SILME,
            TengwaRune.SPACE,
            // of the
            TengwaRune.OF_THE, TengwaRune.SPACE,
            // story
            TengwaRune.SILME, TengwaRune.TINCO, [ TengwaRune.LEFT_CURL, TengwaRune.ROMEN ], TengwaRune.ANNA,
            TengwaRune.SPACE,
            // of the
            TengwaRune.OF_THE, TengwaRune.SPACE,
            // lord
            TengwaRune.LAMBE, [ TengwaRune.LEFT_CURL, TengwaRune.ORE ], TengwaRune.ANDO, TengwaRune.NEWLINE,

            // Line 2
            // of the
            TengwaRune.OF_THE, TengwaRune.SPACE,
            // rings
            TengwaRune.ROMEN, [ TengwaRune.ACUTE, TengwaRune.NGWALME ], TengwaRune.SILME, TengwaRune.PERIOD,
            // herein
            ...
            // who
            TengwaRune.HWESTA_SINDARINWA, [ TengwaRune.LEFT_CURL, TengwaRune.SHORT_CARRIER ], TengwaRune.SPACE,
            // bore
            TengwaRune.UMBAR, [ TengwaRune.LEFT_CURL, TengwaRune.ROMEN, TengwaRune.UNDER_DOT ], TengwaRune.SPACE,
            // the
            TengwaRune.THE, TengwaRune.SPACE,
            // great
    ...
    FONT_LETTERS: [ [ "5", "R" ], " ", "@", " ", [ "7", "&#201;" ], "1", [ "6", "&#225;" ], "5", " ", "W?", " ", "d",
            [ "2", "D" ], [ "y", "Y" ], " ", [ "6", "D", "&#201;" ], " ", "1", "7", [ "i", "D", "&#201;" ], "2", " ",
            "@", " ", "e", [ "6", "R" ], "8", "1", " ", "e", [ "6", "Y" ], "t", "8", " ", "W?", " ", "8", "1",
            [ "7", "Y" ], "h", " ", "W?", " ", "j", [ "6", "Y" ], "2", "W?", " ", "7", [ "b", "R" ], "8", "-", "9",
            [ "7", "T", "&#201;" ], [ "5", "R" ], " ", "@", " ", "s", [ ".", "Y" ], "6", "5", [ "h", "T" ], " ", "W?",
            " ", "9", [ "w", "Y", "&#237;" ], [ "1", "R" ], " ", "o", [ "`", "Y" ], " ", "w", [ "7", "Y", "&#201;" ],
            " ", "@", " ", "x", "7", [ "`", "T", "&#209;" ], "1", " ", "7", [ "b", "R" ], "&#183;", [ "1", "D" ], " ",
            "e", [ "6", "R" ], "8", "1" ],
}
