        ...
        function(TengwaRune)
        {
            ...
            var TengwarExampleTS1 =
            {
                ...
                LANGUAGE_WORDS: [ "the", " ", "tales", " ", "of", " ", "the", " ", "first", " ", "age", " ", "when",
                        ...
                        " ", "elves", " ", "made", " ", "war", " ", "upon", " ", "him", " ", "for", " ", "the", " ",
                        "recovery", " ", "of the", " ", "silmarils", "." ],

                PHONEMES: [ "the", " ", "t", [ "a", "l", "e" ], "s", " ", "of", " ", "the", " ", "f", [ "i", "r" ],
                        "s", "t", " ", [ "a", "j", "e" ], " ", "wh", [ "e", "n" ], " ", "m", [ "o", "r" ], "g",
                        [ "o", "th" ], " ", "d", "w", [ "e", "l" ], "t", " ", [ "i", "n" ], " ", "m",
                        [ "i", "d", "d" ], [ "l", "e" ], " ", [ "e", "a" ], "r", "th", "\n", "and", " ", "the", " ",
                        [ "e", "l" ], [ "v", "e" ], "s", " ", "m", [ "a", "d", "e" ], " ", "w", [ "o", "r" ], " ",
                        [ "u", "p" ], [ "o", "n" ], " ", "h", [ "i", "m" ], " ", "f", [ "o", "r" ], " ", "the", " ",
                ...
                TengwaRune.TINCO, [ TengwaRune.THREE_DOTS, TengwaRune.LAMBE, TengwaRune.UNDER_DOT ], TengwaRune.SILME,
                        ...
                        // dwelt
                        TengwaRune.ANDO, TengwaRune.VALA, [ TengwaRune.DOT, TengwaRune.LAMBE ], TengwaRune.TINCO,
                        TengwaRune.SPACE,
                        // in
                        ...
                        [ TengwaRune.THREE_DOTS, TengwaRune.ROMEN ], [ TengwaRune.ACUTE, TengwaRune.LAMBE ],
                        TengwaRune.SILME, TengwaRune.PERIOD ],

                FONT_LETTERS: [ "@", " ", "1", [ "j", "D", "&#201;" ], "8", " ", "W", " ", "@", " ", "e", [ "6", "R" ],
                        "8", "1", " ", [ "s", "D", "&#201;" ], " ", "o", [ "5", "T" ], " ", "t", [ "6", "Y" ], "x",
                        [ "3", "Y" ], " ", "2", "y", [ "j", "T" ], "1", " ", [ "5", "R" ], " ", "t",
                        [ "2", "R", "&#237;" ], [ "j", "&#201;" ], " ", [ "`", "T", "&#209;" ], "6", "3", [ "2", "{" ],
                        " ", "@", " ", [ "j", "T" ], [ "r", "&#201;" ], "8", " ", "t", [ "2", "D", "&#201;" ], " ",
