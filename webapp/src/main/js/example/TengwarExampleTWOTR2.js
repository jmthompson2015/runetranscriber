...
define(
        ...
        function(TengwaRune)
        {
            ...
            var TengwarExampleTWOTR2 =
            {
                ...
                LANGUAGE_WORDS: [ "journey", " ", "of", " ", "frodo", " ", "with", " ", "samwise", " ", "and", " ",
                        "gollum", " ", "to", " ", "the", " ", "morannon", ",", "of the", "\n", "meeting", " ", "with",
                        " ", "faramir", ",", "and", " ", "the", " ", "stairs", " ", "of", " ", "cirith", " ", "ungol",
                        ",", "of the", " ", "battle", " ", "of the", "\n", "pelennor", " ", "fields", ",", "and", " ",
                        "of the", " ", "coming", " ", "of", " ", "aragorn", " ", "in", " ", "the", " ", "fleet", " ",
                        "of", " ", "umbar", "." ],

                PHONEMES: [ "j", [ "o", "u" ], "r", "n", [ "e", "y" ], " ", "of", " ", "f", "r", [ "o", "d" ], "o",
                        " ", "w", [ "i", "th" ], " ", "s", [ "a", "m" ], "w", [ "i", "s", "e" ], " ", "and", " ", "g",
                        [ "o", "l", "l" ], [ "u", "m" ], " ", "t", "o", " ", "the", " ", "m", [ "o", "r" ],
                        [ "a", "n", "n" ], [ "o", "n" ], ",", "of the", "\n", "m", [ "e", "e", "t" ], [ "i", "ng" ],
                        " ", "w", [ "i", "th" ], " ", "f", [ "a", "r" ], [ "a", "m" ], [ "i", "r" ], ",", "and", " ",
                        "the", " ", "s", "t", "ai", "r", "s", " ", "of", " ", "k", [ "i", "r" ], [ "i", "th" ], " ",
                        [ "u", "ng" ], [ "o", "l" ], ",", "of the", " ", "b", [ "a", "t", "t" ], [ "l", "e" ], " ",
                        "of the", "\n", "p", [ "e", "l" ], [ "e", "n", "n" ], [ "o", "r" ], " ", "f", [ "i", "e" ],
                        "l", "d", "s", ",", "and", " ", "of the", " ", "c", [ "o", "m" ], [ "i", "ng" ], " ", "of",
                        " ", [ "a", "r" ], [ "a", "g" ], [ "o", "r" ], "n", " ", [ "i", "n" ], " ", "the", " ", "f",
                        "l", [ "e", "e", "t" ], " ", "of", " ", [ "u", "m" ], "b", [ "a", "r" ], "." ],
                ...
                TengwaRune.ANGA, [ TengwaRune.LEFT_CURL, TengwaRune.URE ], TengwaRune.ORE, TengwaRune.NUMEN,
                        ...
                        [ TengwaRune.THREE_DOTS, TengwaRune.MALTA ], [ TengwaRune.ACUTE, TengwaRune.ROMEN ],
                        TengwaRune.COMMA,
                        // and
                        [ TengwaRune.BAR, TengwaRune.ANDO ], TengwaRune.SPACE,
                        // the
                        TengwaRune.THE, TengwaRune.SPACE,
                        // stairs
                        TengwaRune.SILME, TengwaRune.TINCO, [ TengwaRune.THREE_DOTS, TengwaRune.YANTA ],
                        TengwaRune.ORE, TengwaRune.SILME, TengwaRune.SPACE,
                        // of
                        TengwaRune.OF, TengwaRune.SPACE,
                        // cirith
                        TengwaRune.QUESSE, [ TengwaRune.ACUTE, TengwaRune.ROMEN ],
                        [ TengwaRune.ACUTE, TengwaRune.THULE ], TengwaRune.SPACE,
                        // ungol,
                        ...
                        // fields,
                        TengwaRune.FORMEN, [ TengwaRune.ACUTE, TengwaRune.SHORT_CARRIER, TengwaRune.UNDER_DOT ],
                        TengwaRune.LAMBE, TengwaRune.ANDO, TengwaRune.SILME, TengwaRune.COMMA,
                        // and
                        [ TengwaRune.BAR, TengwaRune.ANDO ], TengwaRune.SPACE,
                        // of the
                        TengwaRune.OF_THE, TengwaRune.SPACE,
                ...
                FONT_LETTERS: [ "s", [ ".", "Y" ], "6", "5", [ "h", "T" ], " ", "W", " ", "e", "7", [ "2", "Y" ],
                        [ "`", "Y" ], " ", "y", [ "4", "R" ], " ", "8", [ "t", "D" ], "y", [ "8", "R", "&#201;" ], " ",
                        [ "2", "{" ], " ", "x", [ "j", "Y", "&#237;" ], [ "t", "&#225;" ], " ", "1", [ "`", "Y" ], " ",
                        "@", " ", "t", [ "7", "Y" ], [ "5", "D", "&#237;" ], [ "5", "Y" ], "&#183;", "W?", "t",
                        [ "1", "B", "T" ], [ "b", "R" ], " ", "y", [ "4", "R" ], " ", "e", [ "7", "D" ], [ "t", "D" ],
                        [ "7", "R" ], "&#183;", [ "2", "{" ], " ", "@", " ", "8", "1", [ "l", "D" ], "6", "8", " ",
                        "W", " ", "z", [ "7", "R" ], [ "3", "R" ], " ", [ "b", "&#225;" ], [ "j", "Y" ], "&#183;",
                        "W?", " ", "w", [ "1", "D", "&#237;" ], [ "j", "&#201;" ], " ", "W?", "q", [ "j", "T" ],
                        [ "5", "T", "&#237;" ], [ "6", "Y" ], " ", "e", [ "`", "R", "&#201;" ], "j", "2", "8",
                        "&#183;", [ "2", "{" ], " ", "W?", " ", "i", [ "t", "Y" ], [ "b", "R" ], " ", "W", " ",
