...
var TengwarExampleTLOTR2 =
{
    ...
    LANGUAGE_WORDS: [ "of", " ", "westmarch", " ", "by", " ", "john", " ",
            "ronald", " ", "reuel", " ", "tolkien", ".", "herein", " ", "is",
            " ", "set", " ", "forth", "\n", "the", " ", "history", " ",
            "of the", " ", "war", " ", "of the", " ", "ring", " ", "and", " ",
            "the", " ", "return", " ", "of the", " ", "king", " ", "as", " ",
            "seen", " ", "by", " ", "the", " ", "hobbits", "." ],

    PHONEMES: [ "of", " ", "w", [ "i", "s" ], "t", "m", [ "a", "r" ], "ch",
            " ", "b", "y", " ", "j", "h", [ "o", "n" ], " ", "r", [ "o", "n" ],
            [ "a", "l" ], "d", " ", "r", "i", "u", [ "i", "l" ], " ", "t",
            [ "o", "l" ], "k", "e", [ "i", "n" ], ".", "h", [ "i", "r", "e" ],
            [ "e", "n" ], " ", [ "i", "z" ], " ", "s", [ "i", "t" ], " ", "f",
            [ "o", "r" ], "th", "\n", "the", " ", "h", [ "i", "s" ], "t",
            [ "o", "r" ], "y", " ", "of the", " ", "w", [ "o", "r" ], " ",
            "of the", " ", "r", [ "e", "ng" ], " ", "and", " ", "the", " ",
            "r", [ "e", "t" ], [ "u", "r" ], "n", " ", "of the", " ", "k",
            [ "e", "ng" ], " ", [ "a", "z" ], " ", "s", "e", "e", "n", " ",
            "b", "y", " ", "the", " ", "h", [ "o", "b", "b" ], [ "e", "t" ],
            "s", "." ],
    ...
    FONT_LETTERS: [ "W", " ", "y", [ "8", "R" ], "1", "t", [ "6", "D" ], "a",
            " ", "w", [ "~", "R" ], " ", "s", "9", [ "5", "Y" ], " ", "7",
            [ "5", "Y" ], [ "j", "D" ], "2", " ", "7", [ "`", "R" ],
            [ "`", "&#225;" ], [ "j", "R" ], " ", "1", [ "j", "Y" ], "z",
            [ "`", "T" ], [ "5", "R" ], "-", "9", [ "7", "R", "&#201;" ],
