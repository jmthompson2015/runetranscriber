        ...
        PhoneticToRuneTranscriber, InputValidator)
{
    ...
    PhoneticToCirthEreborTranscriber.phonemeToRuneMap["s"] = [ CerthRune.C34 ];
    ...
    PhoneticToCirthEreborTranscriber.phonemeToRuneMap["son"] = [ CerthRune.C34, CerthRune.C56, CerthRune.C53 ];
